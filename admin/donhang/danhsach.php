...
$query_orders = "SELECT o.order_code, o.payment_method, o.status, o.total_amount, u.username AS name, u.phone, u.address
                 FROM orders o
            ...
            <?php if (!empty($orders)): ?>
                <?php foreach ($orders as $order): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($order['address'] ?? 'Chưa có địa chỉ'); ?></td>
